		...
		<div class="overview-box">
			<el-card shadow="never">
			  <div slot="header" class="clearfix">
			    <h2>
			    	<span style="vertical-align:top;margin-right:5px;">合作商：{{source.username}}</span>
			  ...
			  <el-row :gutter="20">
			    ...
			    <el-col :span="8">
			    	<span>下辖种子店</span>
			    	<em class="link-text" @click="handleSeedStore">{{sourceCount.countDutyAreaSeedStore || 0}}</em>
			    </el-col>
			    <el-col :span="8">
			    	<span>下辖特色店</span>
...
<script>
    ...
    methods: {
        ...
        // this.$router.push({path: '/user/promoters', query: {merCode: this.source.code}});
    	},
    	handleSeedStore() {
        ...
        // this.$router.push({path: '/seller/storeList', query: {merManagerType: 2, merManagerLike: this.source.code, storeType: 1}});
    	},
    	handleFeatureStore() {
    		let ids = this.source.managerDutyAreaConfigs.map(item => {
    			return item.areaConfig.id;
    		...
    		this.subDialog.saveFormVisible = true;
        // this.$router.push({path: '/seller/storeList', query: {merManagerType: 2, merManagerLike: this.source.code, storeType: 2}});
    	},
    	handleCityShop() {
        ...
        // this.$router.push({path: '/seller/cityWide', query: {merManagerType: 2, merCode: this.source.code}});
    	},
