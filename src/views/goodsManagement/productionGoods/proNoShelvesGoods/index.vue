<template>
  <div class="app-container calendar-list-container">
    <div class="filter-container">
      ...
      <tree-sidebar-table ref="tableSub" @arrDel="handleDelArr" @del="handleDel"
      ...
      <!--dialog弹窗-->
      <dialog-sub :dialog="dialog" :getDataList="getDataList" @submit="enableGoods">
  ...
  export default {
    ...
    methods: {
      ...
      async enableGoods(row) {
        let res = await this.Api.goodsEnable({'id': row.id});
      ...
      async getDataList(params, areaList, sortObj) { //获取用户列表
        ...
        if (this.quickSearch && this.quickSearch.group) {
          console.log(this.quickSearch, 222);
        ...
        console.log(quick.sellDownType, 3333);
        ...
        let resData = await this.Api.getGoodsProductionDownsaleList(para);
