...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      //   this.Api.editShopEvaluateStatus(params).then(res => {
      //     if (res.status == 1) {
      //       this.$message({
      //         message: '修改成功',
      //         type: 'success',
      ...
      //       });
      //       if (hasRemarks === true) {
      //         let isEnabled = this.operateDialog.ruleForm.isEnabled;
